...
/***/ function(module, exports, __webpack_require__) {
	...
	var uiEvents = __webpack_require__(15);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onNoAccount = function onNoAccount(event) {
	  event.preventDefault();
	  $('#form-signin').hide();
	  $('#no-account').hide();
	  $('#form-signup').show();
	...
	var onBackToSignIn = function onBackToSignIn(event) {
	  event.preventDefault();
	  $('#form-signup').hide();
	  $('#back-to-signin').hide();
	  $('#no-account').show();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(11);
	var gameUi = __webpack_require__(13);

	var displayErrorMessage = function displayErrorMessage(errorText) {
	  $('#display-error').text('');
	  $('#display-error').show();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _require = __webpack_require__(14),
	    cells = _require.cells;

	var player = true;

	// Function to decide if X or O is put in cell
	var cellFill = function cellFill(currentPlayer, cellChoice) {
	  if (currentPlayer) {
	    $(cellChoice).text('X');
	    player = false;
	  } else {
	...
	var cellEvent = function cellEvent(cell) {
	...
	var displayP1Winner = function displayP1Winner() {
	  displayWinner('p1');
	};

	var displayP2Winner = function displayP2Winner() {
	  displayWinner('p2');
	};

	var hideResetBtn = function hideResetBtn() {
	  $('#form-reset').hide();
	};
	...
	module.exports = {
	  cellEvent: cellEvent,
	  displayP1Winner: displayP1Winner,
	  displayP2Winner: displayP2Winner,
...
/***/ function(module, exports) {
	...
	var cells = ['#cell-0', '#cell-1', '#cell-2', '#cell-3', '#cell-4', '#cell-5', '#cell-6', '#cell-7', '#cell-8'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var apiUi = __webpack_require__(18);

	var getFormFields = __webpack_require__(9);

	// generates click event for each cell in gameboard
	var addHandlers = function addHandlers() {
	  cells.forEach(function (cellId, ix) {
	    $(cellId).click(function () {
	      ui.cellEvent(event.target);
	      logic.pushMoveArr(ix);
	      var over = logic.checkWinEvent(event.target.innerHTML);
	      api.updateGame(event.target.innerHTML, ix, over).then(apiUi.updateGameSuccess).catch(apiUi.updateGameFailure);
	    });
	  });
	};

	// play again button event
	$('#form-reset').on('reset', function () {
	  ui.resetGame();
	  onStartGame(event);
	  cells.forEach(function (cellId) {
	    $(cellId).text('');
	...
	var onStartGame = function onStartGame(event) {
	  event.preventDefault();
	  addHandlers();
	  api.createGame().then(apiUi.createGameSuccess).catch(apiUi.createGameFailure);
	...
	var onGetGames = function onGetGames(event) {
	  event.preventDefault();
	  api.getGames().then(apiUi.getGamesSuccess).catch(apiUi.getGamesFailure);
	};
	var onGetOneGame = function onGetOneGame(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.getOneGame(data).then(apiUi.oneGameSuccess).catch(apiUi.oneGameFailure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var currentGame = [null, null, null, null, null, null, null, null, null];

	var winCombos = [[0, 1, 2], [3, 4, 5], [6, 7, 8], [2, 5, 8], [1, 4, 7], [0, 3, 6], [0, 4, 8], [2, 4, 6]];

	var checkPlayerWin = function checkPlayerWin(aWinCombo, player) {
	  var result = aWinCombo.map(function (number) {
	    return currentGame[number];
	  });
	  var maybeWinningCombo = result.every(function (x) {
	    return x === player;
	  });
	...
	var checkDraw = function checkDraw(game) {
	  player = !player;
	  return !game.includes(null);
	};

	var checkWinEvent = function checkWinEvent(player) {
	  var isX = player === 'X';
	  var playerWon = winCombos.some(function (combo) {
	    return checkPlayerWin(combo, isX);
	  });
	...
	var pushMoveArr = function pushMoveArr(index) {
	  currentGame[index] = player;
	};

	var resetGameLogic = function resetGameLogic() {
	  currentGame = [null, null, null, null, null, null, null, null, null];
	  player = true;
	};

	module.exports = {
	  pushMoveArr: pushMoveArr,
	  checkWinEvent: checkWinEvent,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateGame = function updateGame(inCell, ix, over) {
	  return $.ajax({
	...
	var getOneGame = function getOneGame(data) {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getGamesSuccess = function getGamesSuccess(data) {
	  ...
	  var gameList = $('ul.game-list');
	  games.forEach(function (g) {
	    var li = $('<li/>').addClass('ui-menu-item').attr('role', 'menuitem').appendTo(gameList).addClass('ui-all').text('game id ' + g.id).appendTo(li);
	  });
	...
	var oneGameSuccess = function oneGameSuccess(data) {
	  if (data.game.over) {
	...
	var oneGameFailure = function oneGameFailure(error) {
	  if (error.status === 404) {
	...
	module.exports = {
	  ...
	  oneGameSuccess: oneGameSuccess,
	  oneGameFailure: oneGameFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	// imports
	exports.push([module.id, "@import url(https://fonts.googleapis.com/css?family=Asar);", ""]);
